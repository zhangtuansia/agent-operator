...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    GET_FILES_BY_SCOPE: 'sessions:getFilesByScope',
  ...
  onboarding: {
    ...
    GET_EXISTING_CLAUDE_TOKEN: 'onboarding:getExistingClaudeToken',
    IS_CLAUDE_CLI_INSTALLED: 'onboarding:isClaudeCliInstalled',
    RUN_CLAUDE_SETUP_TOKEN: 'onboarding:runClaudeSetupToken',
  ...
  settings: {
    ...
    GET_BILLING_METHOD: 'settings:getBillingMethod',
    UPDATE_BILLING_METHOD: 'settings:updateBillingMethod',
    GET_AGENT_TYPE: 'settings:getAgentType',
    SET_AGENT_TYPE: 'settings:setAgentType',
    CHECK_CODEX_AUTH: 'settings:checkCodexAuth',
    START_CODEX_LOGIN: 'settings:startCodexLogin',
    GET_STORED_CONFIG: 'settings:getStoredConfig',
  ...
  customModels: {
    ...
    SET: 'customModels:set',
    ADD: 'customModels:add',
    UPDATE: 'customModels:update',
    DELETE: 'customModels:delete',
    REORDER: 'customModels:reorder',
  },
  pi: {
  ...
  skills: {
    ...
    IMPORT_URL: 'skills:importUrl',
    IMPORT_CONTENT: 'skills:importContent',
  },
  statuses: {
    LIST: 'statuses:list',
