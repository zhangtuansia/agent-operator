  ...
  async *chat(
    ...
    try {
      ...
      const fullMcpServers: Options['mcpServers'] = {
        ...
        // Coworks documentation - always available for searching setup guides
            ...
            hooks: [async (input) => {
              ...
              if (input.tool_name.startsWith('mcp__')) {
                ...
                if (parts.length >= 3 && serverName) {
                  ...
                  // - agent-operators-docs: always-available documentation search
                  const builtInMcpServers = new Set(['preferences', 'session', 'agent-operators-docs']);
...
// ============================================================
// These aliases allow gradual migration from OperatorAgent to ClaudeAgent.
// Once all consumers are updated, these can be removed.

/** @deprecated Use ClaudeAgent instead */
export { ClaudeAgent as OperatorAgent };

/** @deprecated Use ClaudeAgentConfig instead */
export type { ClaudeAgentConfig as OperatorAgentConfig };
