...
export const IPC_CHANNELS = {
  ...
  BROWSER_PANE_GO_BACK: 'browserPane:goBack',
  BROWSER_PANE_GO_FORWARD: 'browserPane:goForward',
  ...
  BROWSER_PANE_DRAG: 'browserPane:drag',
  BROWSER_PANE_FILL: 'browserPane:fill',
  BROWSER_PANE_SELECT: 'browserPane:select',
  BROWSER_PANE_UPLOAD: 'browserPane:upload',
  BROWSER_PANE_TYPE: 'browserPane:type',
  BROWSER_PANE_KEY: 'browserPane:key',
  ...
  BROWSER_PANE_STATE_CHANGED: 'browserPane:stateChanged',
