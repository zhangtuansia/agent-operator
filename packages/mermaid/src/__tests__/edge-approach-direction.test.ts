...
describe('Edge Approach Direction', () => {
  describe('TD layout - edges should approach targets vertically from top', () => {
    it('simple two-node vertical: final segment should be vertical', async () => {
      const parsed = parseMermaid(`graph TD
        A --> B`)
      const positioned = await layoutGraph(parsed, {})
    ...
    it('fan-out pattern: multiple edges to one target should all be vertical', async () => {
    ...
    it('fan-in and fan-out pattern: all vertical approaches', async () => {
  ...
  describe('LR layout - edges should approach targets horizontally', () => {
    it('simple two-node horizontal: final segment should be horizontal', async () => {
    ...
    it('fan-out pattern in LR: final segments should be horizontal', async () => {
      const parsed = parseMermaid(`graph LR
        Input --> Processor
        Config --> Processor`)
      const positioned = await layoutGraph(parsed, {})
  ...
  describe('Source exit direction matches side', () => {
    it('TD layout: edges should exit source vertically from bottom', async () => {
      const parsed = parseMermaid(`graph TD
        A --> B
        A --> C`)
      const positioned = await layoutGraph(parsed, {})
    ...
    it('LR layout: edges should exit source horizontally from right', async () => {
      const parsed = parseMermaid(`graph LR
        A --> B
        A --> C`)
      const positioned = await layoutGraph(parsed, {})
  ...
  describe('Diamond shapes - approach direction preserved', () => {
    it('edges to diamond should approach with correct direction', async () => {
      const parsed = parseMermaid(`graph TD
        A --> B{Decision}
        B -->|Yes| C
        B -->|No| D`)
    ...
    it('edges should terminate at diamond vertices, not bounding box', async () => {
