...
export const en = {
  ...
  settings: {
    ...
    appDescription: 'Notifications and updates',
    apiDescription: 'Model, thinking, connections',
    appearanceDescription: 'Theme, font, tool icons',
    inputDescription: 'Send key, spell check',
    workspaceDescription: 'Name, icon, working directory',
  ...
  sessionList: {
    ...
    noSessionsYet: 'No chats yet',
    noSessionsYetDescription: 'Start a new conversation to get going.',
    noUnreadSessions: 'No unread sessions',
    noUnreadSessionsDescription: 'New replies will appear here.',
    noReadSessions: 'No read sessions',
    noReadSessionsDescription: 'Read sessions will appear here.',
    noArchivedSessions: 'No archived chats',
    noArchivedSessionsDescription: 'Archived conversations will appear here.',
    ...
    searchInCurrentView: 'Search in current view',
    searchOtherConversations: 'Search other conversations',
    noResultsInCurrentFilter: 'No results in current filter',
    noSessionsFound: 'No conversations found',
    searchedTitlesAndMessages: 'Searched titles and messages.',
  },
  ...
  onboarding: {
    ...
    optBedrock: 'AWS Bedrock',
    optBedrockDesc: 'Use local AWS credentials and environment variables.',
    ...
    connectBedrock: 'Configure AWS Bedrock',
    connectBedrockDesc: 'Use AWS credentials from your local environment.',
    bedrockAuthHint: 'Bedrock authentication uses your local shell environment (AWS_PROFILE/AWS_REGION).',
  ...
  emptyStates: {
    ...
    noReadConversations: 'No read conversations',
    ...
    documentsTreeEmpty: 'The document tree will appear here',
    documentsComingSoon: 'Documents will appear here',
    ...
    selectAutomation: 'Select an automation to view details',
  ...
  documents: {
    ...
    workspaceScopeDescription: 'This view aggregates files and session artifacts from the current workspace.',
    failedToLoad: 'Failed to load documents',
    filterPlaceholder: 'Filter files...',
    noMatches: 'No matching files',
    noMatchesDescription: 'Try another keyword or clear the filter to see the whole workspace.',
  },
  ...
  input: {
    ...
    connectionRemovedDescription: 'This connection was removed or is no longer available.',
    connectionDefaultWithName: 'Default ({name})',
  ...
  toasts: {
    ...
    batchSessionsDeleted: 'Deleted {count} conversations',
    batchAutomationsEnabled: 'Enabled {count} automations',
  ...
  editPopover: {
    ...
    exampleAddAutomation: 'Create a daily 9:00 AM technology news briefing',
    placeholderAddAutomation: 'What automation should I create?',
    ...
    exampleAutomation: 'Add a daily 9 AM automation to summarize yesterday\'s activity',
    placeholderAutomation: 'What automation would you like to create?',
  },
  ...
  scheduledTasks: {
    ...
    notifyError: 'Task failed',
    noRuns: 'No runs yet',
    historyEmpty: 'No run history yet',
    historyColTitle: 'Task',
    historyColTime: 'Time',
    ...
    tabTasks: 'Tasks',
    tabHistory: 'History',
    manageHint: 'Select a task in the middle column to view details.',
    ...
    form: {
      ...
      prompt: 'Prompt',
      promptPlaceholder: 'Enter the prompt for the agent to execute...',
      ...
      modeMonthly: 'Monthly',
      workingDirectory: 'Working Directory',
      workingDirectoryPlaceholder: 'Select or enter a directory path',
      expiresAt: 'Expires At',
      optional: 'optional',
      runCount: 'Run Count',
      runCountPlaceholder: 'e.g. 5',
      runCountHint: 'Auto-sets expiration to {date}',
      enabled: 'Enabled',
      create: 'Create',
      update: 'Update',
    },
    validation: {
      ...
      timeRequired: 'Date and time are required',
      datetimeFuture: 'Date and time must be in the future',
    },
  },
  ...
  automations: {
    ...
    noActionsToExecute: 'No actions to execute',
    failedToToggle: 'Failed to toggle automation',
    failedToDuplicate: 'Failed to duplicate automation',
    failedToDelete: 'Failed to delete automation',
    enable: 'Enable',
    disable: 'Disable',
    runTest: 'Run Test',
    duplicate: 'Duplicate',
    editConfiguration: 'Edit Configuration',
    selectedAutomations: '{count} automations selected',
    ...
    editFile: 'Edit File',
    paused: 'Paused',
    pausedDescription: 'This automation is currently paused and will not run.',
    when: 'When',
    whenDescription: 'Trigger conditions for this automation.',
    event: 'Event',
    timing: 'Timing',
    ...
    then: 'Then',
    actionsToPerform: '{count} action(s) to perform',
    settings: 'Settings',
    ...
    cron: {
      ...
      presetDaily9am: 'Daily at 9:00 AM',
      presetWeekdays9am: 'Weekdays at 9:00 AM',
      presetMonthlyFirst: 'Monthly on day 1',
      fieldMinute: 'Minute',
      fieldHour: 'Hour',
      fieldDay: 'Day',
      fieldMonth: 'Month',
      ...
      advanced: 'Advanced',
      validationFiveParts: 'Cron expression must have 5 parts',
      validationInvalidValue: 'Invalid {field}: {value}',
    },
  },
