...
export const en = {
  ...
  onboarding: {
    ...
    optGlm: '智谱 GLM',
    optGlmDesc: 'Use Zhipu GLM-4.7 and other GLM models via Anthropic-compatible API.',
    optMiniMax: 'MiniMax',
    optMiniMaxDesc: 'Use MiniMax M2.1 flagship model via Anthropic-compatible API.',
